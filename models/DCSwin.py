...
def dcswin_base(pretrained=True, num_classes=4, weight_path='pretrain/stseg_base.pth'):
...
def dcswin_small(pretrained=True, num_classes=4, weight_path='pretrain/stseg_small.pth'):
