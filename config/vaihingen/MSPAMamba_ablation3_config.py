...
weights_name = "mspamamba-ablation3-U"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "mspamamba-ablation3-U"
...
# ====================== 2. 模型配置 ======================
# 消融实验3：移除MSMamba和MPAM，保留CAFMamba
from ours_env.models.MSPAMamba_ablation3 import MSPAMamba, load_pretrained_ckpt
...
if 'train_supervision.py' in sys.argv[0] or 'train' in sys.argv:
    try:
        ...
        print("Successfully loaded pretrained VMamba weights for ablation3")
    except Exception as e:
        print(f"Warning: Could not load pretrained VMamba weights: {e}")
        print("Training ablation3 from scratch.")
else:
