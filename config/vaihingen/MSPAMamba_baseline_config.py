...
weights_name = "mspamamba-baseline-U"
...
# ====================== 2. 模型配置 ======================
# Baseline：所有创新模块都替换为普通Mamba
from ours_env.models.MSPAMamba_baseline import MSPAMamba, load_pretrained_ckpt
...
if 'train_supervision.py' in sys.argv[0] or 'train' in sys.argv:
    try:
        ...
        print("Successfully loaded pretrained VMamba weights for baseline")
